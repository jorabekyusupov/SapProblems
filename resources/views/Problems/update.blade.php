    ...
    <div class="container">
        <form action="{{route('pr.update', ['id'=>$model->id])}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="start_date" name="start_date" placeholder="Start Date" value="{{ $model->start_date ?? ''}}">
            </div>
            <div class="form-group">
                <label for="end_date">End Date</label>
                <input type="date" class="form-control" id="end_date" name="end_date" placeholder="End Date" value="{{ $model->end_date ?? ''}}">
            </div>
        </form>
    </div>
